...
export default function Hero() {
    return (
        <div className="flex flex-col mt-10 md:mt-15">
            <div className="mx-auto w-full px-4 text-center md:w-1/2">
                <h1 className="text-4xl font-bold">Soluções Completa para  Escritório e Escolares</h1>
            ...
            <div className="mt-3 px-4 md:px-0 relative">
                <a href="/catalogo" className="botoes absolute top-0 left-1/2 -translate-x-1/2 text-center text-sm sm:text-base">Veja Nossos Produtos</a>
